...
public class CuentaCorrienteFactory implements CuentaFactory{
    ...
    public Cuenta crearCuenta(String nombreBanco,
        ...
        return new Cuenta(nombreBanco, numeroCuenta, TipoCuenta.CORRIENTE, usuarioAsociado, presupuesto);
    }
}
